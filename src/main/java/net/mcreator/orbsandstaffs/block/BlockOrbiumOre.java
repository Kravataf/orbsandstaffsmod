...
public class BlockOrbiumOre extends ElementsOnS.ModElement {
	@GameRegistry.ObjectHolder("orbsandstaffs:orbiumore")
	public static final Block block = null;
	public BlockOrbiumOre(ElementsOnS instance) {
		super(instance, 7);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("orbiumore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("orbsandstaffs:orbiumore", "inventory"));
	}
