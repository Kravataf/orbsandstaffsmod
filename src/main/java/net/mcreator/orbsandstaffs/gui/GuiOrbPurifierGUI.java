...
public class GuiOrbPurifierGUI extends ElementsOnS.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiOrbPurifierGUI(ElementsOnS instance) {
		super(instance, 20);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("orbsandstaffs:textures/orbpurifiergui.png");
		@Override
