...
package net.mcreator.orbsandstaffs.gui;
...
public class GuiStaffAssemblerGUI extends ElementsOnS.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiStaffAssemblerGUI(ElementsOnS instance) {
		super(instance, 24);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 53, 57) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 53, 21) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 107, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				OnS.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("orbsandstaffs:textures/staffassemblergui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("orbsandstaffs:textures/newfurnacegui (5) (1).png"));
			this.drawTexturedModalRect(this.guiLeft + 75, this.guiTop + 34, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Staff Assembler", 7, 7, -13421773);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 88, this.guiTop + 59, 80, 20, "Assemble"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			OnS.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
